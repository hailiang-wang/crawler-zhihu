...
var common = require('../common'),
    logger = common.loggerUtil.getLogger('database'),
    config = common.argv;
...
function init() {
    connectDB(config.dbUrl)
                    ...
                    col.stats(function(err, stats) {
                        if (err)
                            ...
                            if (stats.nindexes < 2) {
                                ...
                                _empEvent.create("aam:created", null, function(err) {
                                    if (err)
                                        promise.reject(err);
                                    else {
                                        col.ensureIndex({
        ...
        // .then(function() {
        //     var promise = new mongoose.Promise();
        //     // register Object Events which you may interest.
        ...
        .then(function() {
            ...
            exports.connection = dbase;
            exports.empEvent = _empEvent;
            exports.registerEMP = _registerEMP;
